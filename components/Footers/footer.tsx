...
const Footer = () => {
  ...
  return (
    <>
      ...
      {session ? <>{JSON.stringify(session.user)}</> : <>dfffff</>} */}

      <footer className="font-[sans-serif] bg-[#dfe2e6] py-8 px-16">
        <div className="grid max-md-grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            <h4 className="text-black font-semibold text-lg">A propos</h4>
            <p className="text-sm mt-4 text-[#151822]">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean
              gravida, mi eu pulvinar cursus, sem elit interdum mauris dipiscing
              elit. Aenean gravida, mi eu pulvinar cursus...{" "}
              <a href="#" className="text-sm font-semibold text-[#007bff]"></a>
            </p>
            ...
            <ul className="grid max-sm:grid-cols-1 sm:grid-cols-2 mt-12 gap-2">
              <li className="flex items-center max-sm:mb-8">
                ...
                <a href="#" className="text-[#080808] text-sm ml-3">
              ...
              <li className="flex items-center">
                ...
                <a href="#" className="text-[#181616] text-sm ml-3">
          ...
          <div>
            <h4 className="text-black font-semibold text-lg">Newsletter</h4>
            <p className="text-sm mt-4 text-[#0f0707]">
            ...
            <div className="bg-[#dfe2e6] flex px-2 py-1 rounded mt-12">
              <input
                type="email"
                placeholder="Enter your email"
                className="w-full outline-none text-[#0f0707] text-sm bg-transparent pl-4"
              />
              <button
                type="button"
                className="bg-[#007bff] hover:bg-[#2b5ad0] transition-all text-white font-semibold text-sm rounded px-5 py-2 ml-4"
              >
                JE M&apos;INSCRIS
              </button>
            </div>
        ...
        <div className="lg:flex lg:item-center text-center mt-12">
          <ul className="sm:flex max-lg:justify-center space-x-4">
            <li>
              <a href="#" className="text-[#0f0707] hover:text-black text-sm">
          ...
          <p className="text-sm text-[#0f0707] lg:ml-auto max-lg:mt-4">
            Copyright © 2023
            <a
