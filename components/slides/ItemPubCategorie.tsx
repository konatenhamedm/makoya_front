...
const ItemPubCategorie: React.FC<ItemProps> = ({
  image,
  titre,
  desc,
  bouton,
  ...
  return (
    <div className="w-full flex flex-col h-[250px] overflow-hidden rounded-md md:h-[250px] cursor-pointer relative">
...
export default ItemPubCategorie;
